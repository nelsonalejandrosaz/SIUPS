...
<table width="300">
  ...
  <tr>
            <td width="150">  <button formaction="{{ route('certificadoMemoJefe') }}" type="submit" class="btn btn-block btn-primary btn-xs"  style='width:100px; height:40px' target="_blank">Ver Memoria</button> </td>
            <td width="150">
