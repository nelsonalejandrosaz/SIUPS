@extends('serviciosDisponibles.appSDisp')
        ...
        <div class="box-body table-responsive">
          <table id="tablaServicioSocial" class="table table-hover">
            <thead>
             ...
             @if($serviciosocial->estado->nombre=='Disponible')
              <tr>
              <td>{{$serviciosocial->nombre}}</td>
              <td>{{$serviciosocial->beneficiario->nombre}}</td>
              <td>{{$serviciosocial->escuela->nombre}}</td>
              ...
              <td align="center">
                 ...
                 <a href="{{ route('serviciosDisponiblesVer', ['id' => $serviciosocial->id]) }}" class="btn btn-info"><span class="fa fa-eye"></span></a> 
              </td>
            </tr>
            @endif
            @endforeach
